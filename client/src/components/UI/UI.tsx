...
export function UI() {
	...
	const decks = React.useMemo(() => {
		...
		playerList.forEach((player) => {
			if (player.deck === 0) decks.navigation = player.color;
			if (player.deck === 1) decks.cannonLeft = player.color;
			if (player.deck === 2) decks.cannonRight = player.color;
			if (player.deck === 3) decks.lights = player.color;
			if (player.deck === 4) decks.torpedos = player.color;
			if (player.deck === 5) decks.engineering = player.color;
		});
		return decks;
	}, [playerList]);
